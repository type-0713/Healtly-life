...
> = {
  uz: {
    ...
    userTitle: "Kabinetga xavfsiz kirish",
    ...
    registerText: "Yangi foydalanuvchi hisobi ochib bronlash, tarix va profil bo'limlaridan foydalanishni boshlang.",
    ...
    secureText: "Ichki sahifalar endi tizimga kirmagan foydalanuvchilar uchun yopiq.",
    realtimeTitle: "Jonli bron nazorati",
    ...
    quickProviderLogin: "Tizim orqali hisob yaratish",
  ...
  ru: {
    ...
    quickProviderLogin: "Создать аккаунт через Firebase",
  ...
  en: {
    ...
    quickProviderLogin: "Create account via Firebase",
