...
export const userCopy: Record<Language, any> = {
  uz: {
    ...
    realtimeSlots: "Bo'sh vaqtlar doim yangilanib turadi",
    date: "Sana",
    phone: "Telefon",
    ...
    mapText: "Tanlangan doktor uchun manzil va xarita ko'rinishi shu yerda chiqadi.",
    ...
    serviceFlow: "Qulay xizmat jarayoni",
    serviceText: "Tezkor tasdiq va qulay kuzatuv",
    reviewChip: "Baho",
    ...
    successText:
      "Qabulingiz muvaffaqiyatli yaratildi. Endi Qabullar bo'limiga o'tib tafsilotlarni ko'rishingiz va qabul jarayonini kuzatishingiz mumkin.",
    later: "Keyinroq",
