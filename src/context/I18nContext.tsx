...
const knownErrors: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    "Faqat kutilayotgan so'rovni qabul qilish mumkin.": "Принять можно только ожидающий запрос.",
    "Faqat kutilayotgan so'rovni rad etish mumkin.": "Отклонить можно только ожидающий запрос.",
    "Faqat tasdiqlangan qabulni yakunlash mumkin.": "Завершить можно только подтверждённый приём.",
    "Qabul vaqtiga yetmasdan uni yakunlab bo'lmaydi.": "Нельзя завершить приём до наступления его времени.",
  ...
  en: {
    ...
    "Faqat kutilayotgan so'rovni qabul qilish mumkin.": "Only a pending request can be accepted.",
    "Faqat kutilayotgan so'rovni rad etish mumkin.": "Only a pending request can be rejected.",
    "Faqat tasdiqlangan qabulni yakunlash mumkin.": "Only a confirmed appointment can be completed.",
    "Qabul vaqtiga yetmasdan uni yakunlab bo'lmaydi.": "An appointment cannot be completed before its time starts.",
